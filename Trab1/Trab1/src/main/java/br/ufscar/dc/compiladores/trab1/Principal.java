...
public class Principal {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Variável para cada token do léxico da linguagemA ANTLR criado
        Token t = null;
        
        // Cria um vetor de escrita de arquivo do arquivo passado em args[1], utilizando o append para arquivos já criados
        // O arquivo passado em args[1] deve ser o arquivo onde os tokens dos lexemas do código compilado serão escritos.
        ...
        // Cria um buffer de escrita, através do vetor de escrita criado na linha 37
            try (BufferedWriter bw = new BufferedWriter(fileWritter)) {
                ...
                // Enquanto o tipo do próximo token a ser lido não for o token de fim do arquivo,
                // continua lendo cada lexema do código de entrada.
                while ((t = lex.nextToken()).getType() != Token.EOF) {
                    
                    // Modelo padrão de produção do token: <palavra-chave, palavra-chave>
